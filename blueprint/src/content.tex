...
\begin{thm}\label{Satz-2}
	\lean{Satz_2}
	\uses{is_primitive_prime_divisor_Chebyshev, is_exception_Satz2}
	\leanok
...
\begin{prop}\label{RivExer}
	\lean{RivExer}
	%\uses{PUT HERE THE LATEX DECLARATIONS USED IN THIS ENV}
	\leanok
...
\begin{prop}\label{omegas prop b}
	\lean{omegas_prop_b}
	\uses{Omega}
	\leanok
...
\begin{lem}\label{Omega integral}
	\lean{Omega_integral}
	\uses{IsIntPoly}
	\leanok
	$\C_{n}\in \Z[x]$.
...
\begin{cor}\label{if T then Omega}
	\lean{if_T_then_Omega}
	\uses{is_primitive_prime_divisor_Chebyshev, OmegaZ}
	\leanok
	Let $x$ be an integer.
...
\begin{thm}\label{Satz 1}
	\lean{Satz_1_part1,Satz_1_part2, Satz_1_part3_ge_5, Satz_1_part3_p_eq_3_corrected, Satz_1_part3_p_eq_2_corrected}
	\uses{OmegaZ, Che, max_prime_divisor, multiplicity}
	\leanok
...
\begin{cor}\label{wniosek}
	\lean{wniosek}
	\uses{OmegaZ,Che, is_primitive_prime_divisor_Chebyshev, max_prime_divisors, Satz_1_part1, Satz_1_part2}
	\leanok
